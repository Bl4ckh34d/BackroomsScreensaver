...
struct GameSettingsPanelState {
    ...
    bool antiAliasingDropdownOpen = false;
    bool anisotropyDropdownOpen = false;
...
constexpr int kGameSettingsFrameRateLimit = 401;
...
constexpr int kGameSettingsRenderScale = 412;
constexpr int kGameSettingsAntiAliasingDropdown = 414;
constexpr int kGameSettingsAnisotropyDropdown = 415;
constexpr int kGameSettingsMasterVolume = 407;
constexpr int kGameSettingsMusicVolume = 408;
constexpr int kGameSettingsEffectsVolume = 409;
constexpr int kGameSettingsAmbienceVolume = 410;
constexpr int kGameSettingsMonsterVolume = 411;
constexpr int kGameSettingsResolutionOptionBase = 800;
constexpr int kGameSettingsAntiAliasingOptionBase = 840;
constexpr int kGameSettingsAnisotropyOptionBase = 860;
