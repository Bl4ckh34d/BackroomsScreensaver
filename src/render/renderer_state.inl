    ...
    ComPtr<ID3D11ShaderResourceView> ceilingAlbedoSrv_;
    ComPtr<ID3D11ShaderResourceView> ceilingNormalSrv_;
    ComPtr<ID3D11ShaderResourceView> ceilingPropsSrv_;
    ComPtr<ID3D11ShaderResourceView> doorAlbedoSrv_;
    ComPtr<ID3D11ShaderResourceView> doorNormalSrv_;
    ComPtr<ID3D11ShaderResourceView> doorPropsSrv_;
    ComPtr<ID3D11ShaderResourceView> doorFrameAlbedoSrv_;
    ComPtr<ID3D11ShaderResourceView> doorFrameNormalSrv_;
    ComPtr<ID3D11ShaderResourceView> doorFramePropsSrv_;
    ComPtr<ID3D11Texture2D> customMenuTexture_;
    ComPtr<ID3D11ShaderResourceView> customMenuSrv_;
    ...
    int menuButtonCount_ = 4;
    std::array<int, 6> menuButtonLabelRows_{{0, 3, 4, 5, 0, 0}};
    bool menuCustomViewTarget_ = false;
    bool menuCustomViewActive_ = false;
    float menuCustomViewTimer_ = 0.0f;
    float menuCustomReturnTimer_ = 0.0f;
    XMFLOAT3 menuCustomStartCamera_{};
    float menuCustomStartYaw_ = 0.0f;
    float menuCustomStartPitch_ = 0.0f;
    XMFLOAT3 menuCustomReturnCamera_{};
    float menuCustomReturnYaw_ = 0.0f;
    float menuCustomReturnPitch_ = 0.0f;
    CustomGameSpec customMenuSpec_{};
    int customMenuHoverControl_ = 0;
    int customMenuSelectedScare_ = -1;
    bool customMenuTextureDirty_ = true;
    bool menuStartTransitionActive_ = false;
    bool menuStartTransitionComplete_ = false;
    bool menuStartTransitionFromCustomView_ = false;
