        ...
        if (externalSkull) {
            ...
            AppendDynamicEllipsoid(solidVerts, throatFlesh, hRight, hUp, hForward,
                ...
                headSlices(24, 18, 14), headSlices(12, 9, 7), gutMat + 0.032f);
            AppendDynamicEllipsoid(solidVerts, maskFlesh, hRight, hUp, hForward,
                ...
                headSlices(24, 18, 14), headSlices(12, 9, 7), gutMat + 0.046f);
            AppendDynamicEllipsoid(solidVerts, jawFlesh, hRight, hUp, hForward,
                ...
                headSlices(18, 14, 10), headSlices(9, 7, 5), gutMat + 0.058f);
            ...
            AppendDynamicEllipsoid(solidVerts, headMeat, hRight, hUp, hForward,
                {0.420f * modelXZ, 0.400f * modelY, 0.135f * modelXZ}, headSlices(20, 14, 10), headSlices(10, 7, 5), gutMat + 0.04f);
        }
