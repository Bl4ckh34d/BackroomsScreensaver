// Renderer Omukade mask OBJ loading coordinator.

    bool LoadOmukadeMaskObj(const std::filesystem::path& path, std::vector<Vertex>& out) const {
        struct Cluster {
...
#include "renderer_omukade_mask_obj_native.inl"
#include "renderer_omukade_mask_obj_legacy.inl"
    }
